...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = os.getenv('DATABASE_URI', 'sqlite:////app/instance/bitcoin_price.db')
    SQLALCHEMY_TRACK_MODIFICATIONS = False
    
    # Bitcoin price monitoring configuration
    BTC_PRICE_THRESHOLD = float(os.getenv('BTC_PRICE_THRESHOLD', '2.0'))  # Default 1% threshold
